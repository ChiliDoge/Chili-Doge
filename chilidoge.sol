...
⠀⠀⠀⠀⠀⠀⠀⠀⠈⠛⠲⠤⣤⣤⣤⣄⠀⠀⠀⠀⠀⠀⠀⢠⣤⣤⠤⠴⠒⠛⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
 ...
 _______  __   __  ___   ___      ___     ______   _______  _______  _______ 
|       ||  | |  ||   | |   |    |   |   |      | |       ||       ||       |
|       ||  |_|  ||   | |   |    |   |   |  _    ||   _   ||    ___||    ___|
|       ||       ||   | |   |    |   |   | | |   ||  | |  ||   | __ |   |___ 
|      _||       ||   | |   |___ |   |   | |_|   ||  |_|  ||   ||  ||    ___|
|     |_ |   _   ||   | |       ||   |   |       ||       ||   |_| ||   |___ 
|_______||__| |__||___| |_______||___|   |______| |_______||_______||_______| 
  
   #ChiliDoge - THE SUMPREME CHILI DOGE HUT ORIGINAL SUPER OFFICIAL CONTRACT
   
   Welcome to the Chili Doge community, the coolest Doge Chain Token on the Block. 

   Website: https://www.chilidoge.com

   Telegram: https://t.me/+hxR5Ut2vb1NlOWMy

   Twitter: https://twitter.com/dogechili

   Discord: https://discord.gg/v7fy2Tmvzs
...
contract CHILIDOGE is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 420420 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 1000;
    ...
    string constant _name = "Chili Doge";
    string constant _symbol = "CHILI";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x071Ec5A22011dCf7fA95B00BB16010F08a82cDC6;
        marketingWallet = 0x0E5d2F43d624af937A237a3271b787B85d94A80D;
        devWallet = 0x071Ec5A22011dCf7fA95B00BB16010F08a82cDC6;
